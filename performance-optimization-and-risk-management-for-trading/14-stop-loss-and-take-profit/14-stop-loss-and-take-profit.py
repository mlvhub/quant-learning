...
# In total 253 separate Trading Sessions.
...
# __Plan__: whenever the __compound return hits minus two percent__, close the trading postion and __go neutral__ and keep the neutral position __for the rest of the trading session__ (start trading again when the next trading session starts).
...
# ## Stop Loss & Take Profit - A Deeper Analysis
...
# ### 1. Profitable Underlying Strategy (Simple Contrarian for EURUSD)
...
# ### 2. Unprofitable Underlying Strategy (Simple Momentum for EURUSD)
...
# ### 1.a Profitable Strategy & Stop Loss
...
# ### 1.b Profitable Strategy & Take Profit
...
# ### 2.a Unprofitable Strategy and Stop Loss
...
# ### 2.b Unprofitable Strategy and Take Profit
